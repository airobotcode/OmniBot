...
function Update-OmniBotCodebase {
    ...
    Set-Content -Path "lib\config\app_config.dart" -Encoding UTF8 -Value "class AppConfig {
...
# 4. Git 提交与 Tag 触发 Github Actions
...
Write-Host "   Set-OmniBotEnv         - 设置代理 (默认 127.0.0.1:7890)" -ForegroundColor LightGray
Write-Host "   Update-OmniBotCodebase - 重新写入核心文件配置" -ForegroundColor LightGray
Write-Host "   Build-OmniBotAll       - 一键编译 Web/Win/Android" -ForegroundColor LightGray
Write-Host "   Publish-OmniBotRelease - 提交 Git 并触发 Git Tag 自动发布" -ForegroundColor LightGray
Write-Host "==========================================" -ForegroundColor Yellow
